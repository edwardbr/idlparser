...
function(build_flatbuffers flatbuffers_schemas
  ...
  foreach(schema ${flatbuffers_schemas})
    ...
    set(generated_includes_dir_tmp ${generated_includes_dir}/_tmp)
    set(generated_include ${generated_includes_dir}/${filename}_fb.h)
    set(generated_include_tmp ${generated_includes_dir_tmp}/${filename}_fb.h)
    message("generated_includes_dir_tmp ${generated_includes_dir_tmp}")
    message("generated_includes_dir ${generated_includes_dir}")
    add_custom_command(
        OUTPUT ${generated_include}
        COMMAND ${FLATC} --cpp
        -o ${generated_includes_dir_tmp}
        ${include_params}
        -c ${schema}
        --filename-suffix _fb
        COMMAND ${CMAKE_COMMAND} -E copy
        "${generated_include_tmp}" "${generated_include}"
