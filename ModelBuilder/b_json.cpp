...
namespace blocking
{
	namespace json
	{
		...
		void buildStructureMembers(const ClassObject* pObj, ostringstream& cos, ostringstream& jos)
		{
			if(pObj->parentName != "")
			{
		...
		void writeStructureItems(const ClassObject* pObj, ostringstream& cos, std::string& dereferencer, ostringstream& jos)
		{
			if(pObj->parentName != "")
			{
				const ClassObject* pParent = NULL;
