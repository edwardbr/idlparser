...
bool is_word(const char* string1, const char* string2)
{
    ...
    if ((*string1 >= '0' && *string1 <= '9') || (*string1 >= 'A' && *string1 <= 'Z')
        || (*string1 >= 'a' && *string1 <= 'z') || (*string1 == '_'))
        return false;
    return true;
}
...
{
    std::string temp;
    while ((*pData >= '0' && *pData <= '9') || (*pData >= 'A' && *pData <= 'Z') || (*pData >= 'a' && *pData <= 'z')
           || (*pData == '_'))
        temp += *pData++;
    retval += temp;
...
bool extract_multiline_string_literal(const char*& pData, const char*& pStart, const char*& pSuffix)
{
    ...
    while (*pData && *pData != '(')
    {
        if (!((*pData >= '0' && *pData <= '9') || (*pData >= 'A' && *pData <= 'Z') || (*pData >= 'a' && *pData <= 'z')
              || (*pData == '_')))
